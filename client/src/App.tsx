  ...
  return (
    <DashboardLayout>
      <Switch>
        ...
        <Route path="/development" component={DevelopmentProfile} />
        <Route path="/development-continuity" component={DevelopmentContinuity} />
        <Route path="/development-governance" component={DevelopmentGovernance} />
        <Route path="/community-intelligence" component={CommunityIntelligence} />
        <Route path="/chamber" component={ChamberHome} />
        <Route path="/chamber/:id" component={ChamberSession} />
        <Route path="/media" component={MediaCommand} />
        <Route path="/media/:id" component={MediaDraftReview} />
        <Route path="/intake" component={Intake} />
        <Route path="/queue" component={Queue} />
        <Route path="/actions" component={Actions} />
        <Route path="/test-mode" component={TestMode} />
        <Route path="/officer-access" component={OfficerAccess} />
        <Route path="/review/:id" component={ReviewRecord} />
